$("#kt_datatable_licenses").DataTable({
	...
	'columns': [
{
            data: null,      // DataTables will not look for data for this column
            defaultContent: '', // Ensure the cell is empty if no HTML is provided
            orderable: false // This column shouldn't be sortable
        },
        // 2. The rest of your columns are now correctly shifted by 1
        {
            data: 'key'
        },
        {
            data: 'gendate'  // You may need to verify your backend field name for "Creation Date"
        },
        {
            data: 'genby'    // Maps to "Generated By"
        },
        {
            data: 'expires'  // Maps to "Duration" in your HTML
        },
        {
            data: 'note'
        },
        {
            data: 'usedon'   // Maps to "Used On"
        },
        {
            data: 'usedby'   // Maps to "Used By"
        },
        {
            data: 'status'
        },
